...
class SiteHeader extends HTMLElement{
  connectedCallback(){this.innerHTML=`<header class="site-header scrolled"><div class="container nav-wrap">
    <a class="brand" href="index.html"><span class="brand-mark">O</span><span>oso<span>easy</span></span></a>
...
class SiteFooter extends HTMLElement{
  connectedCallback(){this.innerHTML=`<footer><div class="container footer-grid"><div class="footer-brand"><a class="brand brand-light" href="index.html"><span class="brand-mark">O</span><span>oso<span>easy</span></span></a><p>The operating system for modern laundry and dry-cleaning businesses.</p></div><div><h3>Solutions</h3><a href="single-store.html">Single Store</a><a href="multi-store.html">Multi Store</a><a href="new-business.html">New Business</a><a href="b2b.html">B2B</a></div><div><h3>Product</h3><a href="features.html">Features</a><a href="pricing.html">Pricing</a><a href="testimonials.html">Testimonials</a></div><div><h3>Company</h3><a href="why-fabklean.html">About</a><a href="contact.html">Contact</a><a href="blogs.html">Blog</a></div><div><h3>Ready to grow?</h3><p>Explore every feature free for 14 days.</p><a class="btn btn-primary" href="signup.html">Start free trial →</a></div></div><div class="container footer-bottom"><span>© 2026 OsoEasy. All rights reserved.</span><div><a href="privacy-policy.html">Privacy</a><a href="terms-and-conditions.html">Terms</a></div></div></footer>`}
}
