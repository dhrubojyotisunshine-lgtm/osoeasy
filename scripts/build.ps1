...
$required = @('index.html', 'features.html', 'pricing.html', 'contact.html', 'styles.css', 'pages.css', 'app.js', 'components.js', 'pages.js', 'assets\laundry-platform-hero.png', 'assets\moorezy-logo.png')
